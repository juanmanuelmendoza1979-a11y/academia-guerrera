...
function mensajeErrorFirebase(e) {
  ...
  if (code.includes('permission-denied'))return '🔒 Reglas de Firebase bloqueando acceso — actualiza las reglas en la consola Firebase (Firestore → Rules → allow read, write: if true).'
  if (code.includes('not-found'))        return '⚠️ Base de datos no encontrada.'
