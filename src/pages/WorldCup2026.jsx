...
const MATCHUPS = [
  {
    ...
    visita: { nombre: 'Alemania', bandera: '🇩🇪', color: '#6b7280' },
    fecha: 'Fase de grupos', hora: 'Por confirmar',
    datoCaliente: 'Brasil invicto en 5 partidos mundialistas recientes',
    indicador: '🔥 Local fuerte',
    tendencia: 'local',
    cta: 'Señor, Brasil viene muy fuerte en esta fase. ¿Le armamos el ticket con el ganador o doble oportunidad?',
    mercados: ['Ganador', 'Doble Oportunidad', 'Más de 1.5 goles'],
  },
  {
    id: 'm2',
    local: { nombre: 'Francia', bandera: '🇫🇷', color: '#3b82f6' },
    visita: { nombre: 'Portugal', bandera: '🇵🇹', color: '#ef4444' },
    fecha: 'Fase de grupos', hora: 'Por confirmar',
    datoCaliente: 'Francia y Portugal: ambos anotaron en sus últimos 4 encuentros directos',
    indicador: '⚽ Partido de goles',
    tendencia: 'empate',
    cta: '"Señor, estos dos equipos siempre dan goles. ¿Le revisamos Ambos Anotan o Más de 2.5?"',
  ...
  },
  {
    ...
    fecha: 'Fase de grupos', hora: 'Por confirmar',
    datoCaliente: 'Argentina: campeón defensor. Croacia: mejor segundo equipo del mundo en 2022',
    indicador: '⚡ Duelo de alto voltaje',
    tendencia: 'local',
    cta: '"Este es un partido para no perderse. ¿Le armamos algo con Argentina ganador o una combinada corta?"',
    mercados: ['Ganador', 'Combinada corta', 'Resultado exacto'],
  },
  {
    id: 'm4',
    local: { nombre: 'España', bandera: '🇪🇸', color: '#facc15' },
    visita: { nombre: 'Inglaterra', bandera: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', color: '#f9fafb' },
    fecha: 'Fase de grupos', hora: 'Por confirmar',
    datoCaliente: 'España: bicampeón Euro. Inglaterra: finalista Euro 2024. Ambos sin perder en 6 partidos',
    indicador: '🔥🔥 Clásico europeo',
    tendencia: 'empate',
    cta: '"Señor, este partido puede ser empate o ganador cualquiera. ¿Le revisamos Doble Oportunidad para cubrirse mejor?"',
    mercados: ['Doble Oportunidad', 'Ambos Anotan', 'BetBuilder'],
  },
  {
    id: 'm5',
    local: { nombre: 'México', bandera: '🇲🇽', color: '#22c55e' },
    visita: { nombre: 'USA', bandera: '🇺🇸', color: '#3b82f6' },
    fecha: 'Partido anfitrión', hora: 'Por confirmar',
    datoCaliente: 'El Clásico CONCACAF: máxima rivalidad regional. Partido de alto impacto para el torneo',
    indicador: '🌎 Clásico CONCACAF',
    tendencia: 'empate',
    cta: '"Este es el partido más esperado del torneo para América. ¿Le armamos algo con ambos anotan o ganador?"',
